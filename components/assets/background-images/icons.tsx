...
export const mapIconData = [
  ...
  { // 0: Top-Left Stores 1 (row 1, col 2)
    viewBox: "0 0 640 512",
    icon: svgPathVal.restroom,
  },
  { // 1: Top-Left Stores 2 (row 1, col 4)
    viewBox: "0 0 640 512",
    icon: svgPathVal.pie
  },
  { // 2: Top-Left Stores 3 (row 1, col 6)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
  { // 3: Top-Left Stores 4 (row 1, col 8)
    viewBox: "0 0 640 512",
    icon: svgPathVal.coffee
  },
  { // 4: Top-Left Stores 5 (row 1, col 10)
    viewBox: "0 0 512 512",
    icon: svgPathVal.pizza
  },
  { // 5: Top-Left Stores 6 (row 1, col 11) - Same as 4
    viewBox: "0 0 512 512",
    icon: svgPathVal.pizza
  },
  { // 6: Top-Left Stores 7 (row 1, col 12) - Same as 2
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
  { // 7: Top-Left Stores 8 (row 1, col 15) - Same as 2
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
  { // 8: Leftmost Store (row 3, col 1)
    viewBox: "0 0 24 24",
    icon: svgPathVal.clothing
  },

  // Top-Right Stores (Indices 9-23)
  { // 9: Top-Right Stores 1 (row 1, col 20) - Cookie
    viewBox: "0 0 256 256",
    icon: svgPathVal.cookie
  },
  { // 10: Top-Right Stores 2 (row 1, col 21) - Cookie
    viewBox: "0 0 256 256",
    icon: svgPathVal.cookie
  },
   { // 11: Top-Right Stores 3 (row 1, col 22) - Cookie
    viewBox: "0 0 256 256",
    icon: svgPathVal.cookie
  },
   { // 12: Top-Right Stores 4 (row 1, col 23) - Cookie
    viewBox: "0 0 256 256",
    icon: svgPathVal.cookie
  },
   { // 13: Top-Right Stores 5 (row 1, col 24) - Cookie
    viewBox: "0 0 256 256",
    icon: svgPathVal.cookie
  },
   { // 14: Top-Right Stores 6 (row 1, col 25) - Cookie
    viewBox: "0 0 256 256",
    icon: svgPathVal.cookie
  },
  { // 15: Top-Right Stores 7 (row 1, col 26) - Key
    viewBox: "0 0 24 24",
    icon: svgPathVal.notebook
  },
  { // 16: Top-Right Stores 8 (row 1, col 27) - Cart
    viewBox: "0 0 576 512",
    icon: svgPathVal.basket
  },
  { // 17: Top-Right Stores 9 (row 1, col 28) - Cart
    viewBox: "0 0 576 512",
    icon: svgPathVal.basket
  },
  { // 18: Top-Right Stores 10 (row 1, col 29) - Cart
    viewBox: "0 0 576 512",
    icon: svgPathVal.basket
  },
  { // 19: Top-Right Stores 11 (row 1, col 30) - Cart
    viewBox: "0 0 576 512",
    icon: svgPathVal.basket
  },
  { // 20: Top-Right Stores 12 (row 1, col 31) - Cart
    viewBox: "0 0 576 512",
    icon: svgPathVal.basket
  },
  { // 21: Top-Right Stores 13 (row 1, col 32) - Scissors
    viewBox: "0 0 512 512",
    icon: svgPathVal.veggie
  },
  { // 22: Top-Right Stores 14 (row 1, col 33) - Scissors
    viewBox: "0 0 512 512",
    icon: svgPathVal.veggie
  },
  { // 23: Top-Right Stores 15 (row 1, col 34) - Scissors
    viewBox: "0 0 512 512",
    icon: svgPathVal.veggie
  },
  { // 24: Top-Right Stores 16 (row 1, col 35) - Scissors
    viewBox: "0 0 512 512",
    icon: svgPathVal.veggie
  },
  { // 25: Top-Right Stores 17 (row 1, col 36) - Scissors
    viewBox: "0 0 512 512",
    icon: svgPathVal.veggie
  },
  { // 26: Top-Right Stores 18 (row 1, col 37) - Dropper
    viewBox: "0 0 24 24",
    icon: svgPathVal.meat
  },

  // Rightmost Stores (Indices 27-38) - All same viewBox (index 2 for icon)
  { // 27: Rightmost 1 (row 4, col 39)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
  { // 28: Rightmost 2 (row 5, col 39)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
  { // 29: Rightmost 3 (row 6, col 39)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
   { // 30: Rightmost 4 (row 7, col 39)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
   { // 31: Rightmost 5 (row 8, col 39)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
   { // 32: Rightmost 6 (row 9, col 39)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
   { // 33: Rightmost 7 (row 10, col 39)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
   { // 34: Rightmost 8 (row 11, col 39)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
  { // 35: Rightmost 9 (row 13, col 39)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
   { // 36: Rightmost 10 (row 14, col 39)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
  { // 37: Rightmost 11 (row 15, col 39)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
   { // 38: Rightmost 12 (row 16, col 39)
    viewBox: "0 0 24 24",
    icon: svgPathVal.eatery
  },
  { // 39: Rightmost 13 (row 17, col 39)
    viewBox: "0 0 576 512",
    icon: svgPathVal.money
  },

  // Bottom Stores (Indices 40-51)
  { // 40: Bottom 1 (row 18, col 25)
    viewBox: "0 0 576 512",
    icon: svgPathVal.money
  },
  { // 41: Bottom 2 (row 18, col 27)
    viewBox: "0 0 24 24",
    icon: svgPathVal.clothing
  },
  { // 42: Bottom 3 (row 18, col 28)
    viewBox: "0 0 640 512",
    icon: svgPathVal.pie
  },
  { // 43: Bottom 4 (row 18, col 29) - Scissors Cross
    viewBox: "0 0 512 512",
    icon: svgPathVal.haircut
  },
  { // 44: Bottom 5 (row 18, col 30)
    viewBox: "0 0 24 24",
    icon: svgPathVal.clothing
  },
  { // 45: Bottom 6 (row 18, col 31)
    viewBox: "0 0 24 24",
    icon: svgPathVal.clothing
  },
  { // 46: Bottom 7 (row 19, col 25)
    viewBox: "0 0 24 24",
    icon: svgPathVal.clothing
  },
  { // 47: Bottom 8 (row 19, col 27) - Envelope
    viewBox: "0 0 20 20",
    icon: svgPathVal.mail
  },
  { // 48: Bottom 9 (row 19, col 28)
    viewBox: "0 0 24 24",
    icon: svgPathVal.milk
  },
  { // 49: Bottom 10 (row 19, col 29) - Cart
    viewBox: "0 0 576 512",
    icon: svgPathVal.basket
  },
  { // 50: Bottom 11 (row 19, col 30) - Cart
    viewBox: "0 0 576 512",
    icon: svgPathVal.basket
  },
  { // 51: Bottom 12 (row 19, col 31) - Wallet
    viewBox: "0 0 14 14",
    icon: svgPathVal.printer
  },
  { // 52: Bottom 13 (row 19, col 32) - Wallet
    viewBox: "0 0 14 14",
    icon: svgPathVal.printer
  },

  // Central Places (Indices 53-56)
  { // 53: Central 1 (row 5, col 20) - Shield Person
    viewBox: "0 0 24 24",
    icon: svgPathVal.personnel
  },
  { // 54: Central 2 (row 7, col 25) - Tree
    viewBox: "0 0 100 100",
    icon: svgPathVal.park
  },
  { // 55: Central 3 (row 13, col 34) - Location Pin Check
    viewBox: "0 0 24 24",
    icon: svgPathVal.water
  },
  { // 56: Central 4 (row 15, col 34) - Scissors Cross
    viewBox: "0 0 512 512",
    icon: svgPathVal.haircut
  },
  { // 57: Central 5 (row 15, col 35) - Shield Person
    viewBox: "0 0 24 24",
    icon: svgPathVal.personnel
  },
];
